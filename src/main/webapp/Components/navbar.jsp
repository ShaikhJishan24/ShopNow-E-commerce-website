<%@page import="com.shopnow.entities.Admin"%>
<%@page import="com.shopnow.entities.Cart"%>
<%@page import="com.shopnow.dao.CartDao"%>
<%@page import="com.shopnow.entities.User"%>
<%@page import="java.util.List"%>
<%@page import="com.shopnow.entities.Category"%>
<%@page import="com.shopnow.helper.ConnectionProvider"%>
<%@page import="com.shopnow.dao.CategoryDao"%>
<%
...
<nav class="navbar navbar-expand-lg custom-color " data-bs-theme="dark">
	...
	<div class="container">
		<a class="navbar-brand" href="admin.jsp"><i
			class="fa-sharp fa-solid fa-house" style="color: #ffffff;"></i>&ensp;SopNow</a>
	...
	<div class="container">
		<a class="navbar-brand" href="index.jsp"><i
			class="fa-sharp fa-solid fa-house" style="color: #ffffff;"></i>&ensp;ShopNow</a>
		<button class="navbar-toggler" type="button" data-bs-toggle="collapse"
			data-bs-target="#navbarSupportedContent"
			aria-controls="navbarSupportedContent" aria-expanded="false"
			aria-label="Toggle navigation">
