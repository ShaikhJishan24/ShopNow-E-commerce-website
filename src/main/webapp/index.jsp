<%@page import="com.shopnow.dao.ProductDao"%>
<%@page import="com.shopnow.entities.Product"%>
					...
					<a href="products.jsp?category=<%=c.getCategoryId()%>"
						...
						<div class="card cus-card h-100">
							<div class="container text-center">
								<img src="<%=request.getContextPath()%>/Product_imgs\<%=c.getCategoryImage()%>" class="mt-3 "
	...
	<div id="carouselAutoplaying"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="Images/scroll_img2.jpg" class="d-block w-100" alt="...">
			</div>
			<div class="carousel-item">
				<img src="Images/sc1.webp" class="d-block w-100 " style="height: 302px" alt="...">
			</div>
			<div class="carousel-item">
				<img src="Images/sc2.webp" class="d-block w-100" style="height: 302px" alt="...">
			</div>
		</div>
